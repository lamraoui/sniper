...
function runPFTFsg {
	...
	./../../sniper -ce -ptf -function foo -cfile $1 $1.bc -small-gra
	rm $1.bc	
}
...
function runPFTFbg {
	...
	echo "< $1 >"
	clang $1 -S -emit-llvm -O0 -g -o $1.bc >error 2>&1
	./../../sniper -ce -ptf -function foo -cfile $1 $1.bc
	rm $1.bc	
}
...
function runTFsg {
	...
	echo "< $1 >"
	clang $1 -S -emit-llvm -O0 -g -o $1.bc >error 2>&1
	./../../sniper -ce -function foo -cfile $1 $1.bc -small-gra
	rm $1.bc	
}
...
function runTFbg {
	...
	echo "< $1 >"
	clang $1 -S -emit-llvm -O0 -g -o $1.bc >error 2>&1
	./../../sniper -ce -function foo -cfile $1 $1.bc 
	rm $1.bc	
}
