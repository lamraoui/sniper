...
// Modified MAIN()
int main(
         int _Cur_Vertical_Sep,
         int _High_Confidence,
         int _Two_of_Three_Reports_Valid,
         int _Own_Tracked_Alt,
         int _Own_Tracked_Alt_Rate,
         int _Other_Tracked_Alt,
         int _Alt_Layer_Value,
         int _Up_Separation,
         int _Down_Separation,
         int _Other_RAC,
         int _Other_Capability,
         int _Climb_Inhibit
) {
    ...
    // ARGS
    Cur_Vertical_Sep            = _Cur_Vertical_Sep;
    High_Confidence             = _High_Confidence; 
    Two_of_Three_Reports_Valid  = _Two_of_Three_Reports_Valid;
    Own_Tracked_Alt             = _Own_Tracked_Alt;
    Own_Tracked_Alt_Rate        = _Own_Tracked_Alt_Rate;
    Other_Tracked_Alt           = _Other_Tracked_Alt;
    Alt_Layer_Value             = _Alt_Layer_Value;
    Up_Separation               = _Up_Separation;
    Down_Separation             = _Down_Separation;
    Other_RAC                   = _Other_RAC;
    Other_Capability            = _Other_Capability;
    Climb_Inhibit               = _Climb_Inhibit;
