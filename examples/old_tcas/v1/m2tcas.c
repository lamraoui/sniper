...
int Positive_RA_Alt_Thresh0; 
int Positive_RA_Alt_Thresh1; 
int Positive_RA_Alt_Thresh2;
int Positive_RA_Alt_Thresh3;

int Up_Separation;
int Down_Separation;
bool Own_Below_Threat(){return (Own_Tracked_Alt < Other_Tracked_Alt);}
bool Own_Above_Threat(){return (Other_Tracked_Alt < Own_Tracked_Alt);}
...
void initialize()
{
    Positive_RA_Alt_Thresh0 = 400; 
    Positive_RA_Alt_Thresh1 = 500; 
    Positive_RA_Alt_Thresh2 = 640;
    Positive_RA_Alt_Thresh3 = 740;
}

int ALIM ()
{
    if (Alt_Layer_Value==0) {
        return Positive_RA_Alt_Thresh0; 
    } else if (Alt_Layer_Value==1) {
        return Positive_RA_Alt_Thresh1; 
    } else if (Alt_Layer_Value==2) {
        return Positive_RA_Alt_Thresh2; 
    } else if (Alt_Layer_Value==3) {
        return Positive_RA_Alt_Thresh3; 
    }
}
