...
void initialize()
{
    Positive_RA_Alt_Thresh[1] = 400; /* index */
    Positive_RA_Alt_Thresh[2] = 500; /* index */
    Positive_RA_Alt_Thresh[3] = 640; /* index */
    Positive_RA_Alt_Thresh[4] = 740; /* index */
}
