...
void foo(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9
    ...
    //if(arg7<0 || arg7>3) return; //exit(1);
    initialize();
    ...
    /*
    assert((((High_Confidence && (Own_Tracked_Alt_Rate <= 600) && (Cur_Vertical_Sep > 600))  && (((Other_Capability == 1) && (Two_of_Three_Reports_Valid && Other_RAC == 0)) || !(Other_Capability == 1))) && (Alt_Layer_Value==0) && ((ret_alt_sep_test==UPWARD_RA) && ((((Climb_Inhibit ? Up_Separation + 100 : Up_Separation) > Down_Separation) && (!(Own_Tracked_Alt < Other_Tracked_Alt) || ((Own_Tracked_Alt < Other_Tracked_Alt) && (!((Alt_Layer_Value==0 && Down_Separation>=400)   || (Alt_Layer_Value==1 && Down_Separation>=500) || (Alt_Layer_Value==2 && Down_Separation>=640) || (Alt_Layer_Value==3 && Down_Separation>=740)))))) || (((Climb_Inhibit ? Up_Separation + 100 : Up_Separation) > Down_Separation) && ((Other_Tracked_Alt < Own_Tracked_Alt) && (Cur_Vertical_Sep >= 300) && ((Alt_Layer_Value==0 && Up_Separation>=400)  || (Alt_Layer_Value==1 && Up_Separation>=500)  || (Alt_Layer_Value==2 && Up_Separation>=640)  || (Alt_Layer_Value==3 && Up_Separation>=740))))
              && (Own_Tracked_Alt < Other_Tracked_Alt))) 
            ||  ((ret_alt_sep_test==DOWNWARD_RA) &&  ((((Climb_Inhibit ? Up_Separation + 100 : Up_Separation) > Down_Separation)
