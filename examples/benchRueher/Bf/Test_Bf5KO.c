int Bf5KO(int ggg){
    ...
    assume((Source[0]==0 && Source[1]==0 && Source[2]==0 && Source[3]==3 && Source[4]==4) && (Dest[0]==1 && Dest[1]==0 && Dest[2]==0 && Dest[3]==1 && Dest[4]==1) && (Weight[0]==0 && Weight[1]==1 && Weight[2]==2 && Weight[3]==3 && Weight[4]==4));
